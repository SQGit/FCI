 ...
 * {@link CameraSource1.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class CameraSource1 {
    ...
    public static class Builder {
        ...
        private CameraSource1 mCameraSource = new CameraSource1();
    ...
    public CameraSource1 start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public CameraSource1 start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
