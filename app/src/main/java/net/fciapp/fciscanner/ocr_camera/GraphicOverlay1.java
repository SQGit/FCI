 ...
 */
package net.fciapp.fciscanner.ocr_camera;
 ...
 * </ol>
 */
public class GraphicOverlay1<T extends GraphicOverlay1.Graphic> extends View {
     ...
     * graphics element.  Add instances to the overlay using {@link GraphicOverlay1#add(Graphic)}.
     */
    public static abstract class Graphic {
        private GraphicOverlay1 mOverlay;

        public Graphic(GraphicOverlay1 overlay) {
            mOverlay = overlay;
        }
    ...
    public GraphicOverlay1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
