...
public class AdapterCompanyEdit extends BaseAdapter {
    ...
    ArrayList<String> alt_manger = new ArrayList<>();
    ...
    AdapterCompanyEdit(Context c1, ArrayList<String> name, ArrayList<String> location, ArrayList<String> email, ArrayList<String> manager_phone, ArrayList<String> manager_name, ArrayList<String> alt_name, ArrayList<String> alt_phone) {
        this.context = c1;
        this.com_name = name;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        tv_editview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                goupdate.putExtra("alt_manager", alt_manger.get(position));
                goupdate.putExtra("alt_phone", alt_phone.get(position));
                ...
                if (status.equals("success")) {
                    new SweetAlertDialog(context, SweetAlertDialog.SUCCESS_TYPE)
                            ...
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                ...
                                public void onClick(SweetAlertDialog sweetAlertDialog) {
                                    sweetAlertDialog.dismiss();
                                    Intent goDash = new Intent(context, AdminCompanyEdit.class);
